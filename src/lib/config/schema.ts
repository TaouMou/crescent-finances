...
// Pure, zod-free config builders live in ./defaults so boot-path modules can seed
// a vault without loading zod. Re-exported here for the validation-centric callers
// (and existing tests) that import everything config-shaped from one place.
export { SCHEMA_VERSION, starterCategories, starterRules, emptyConfig } from './defaults';
